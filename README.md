...
Once the `conda-forge` channel has been enabled, `pqdm` can be installed with:

```
conda install pqdm
```

It is possible to list all of the versions of `pqdm` available on your platform with:
